-- Função simplificada que não depende de funções que podem não existir
...
BEGIN
  ...
  -- Criar salt simples usando dados disponíveis
  salt := '$2a$10$' || substr(md5(random()::text || clock_timestamp()::text), 1, 22);
