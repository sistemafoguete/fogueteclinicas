...
CREATE POLICY "Administrative staff can manage financial records" ON public.financial_records
  FOR ALL USING (public.user_has_role(ARRAY['director'::employee_role, 'administrative'::employee_role]));
