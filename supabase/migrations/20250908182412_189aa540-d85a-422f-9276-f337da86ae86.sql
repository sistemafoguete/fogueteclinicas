-- Create sample employees with matching login/password using only valid role enum values
-- Only using: director, coordinator_madre, coordinator_floresta, administrative, staff

-- Insert sample employee profiles with only valid roles
...
('44444444-4444-4444-4444-444444444444', 'Recepcionista Carla Souza', 'administrative', '(11) 99999-4444', '444.444.444-44', 'PR-44.444.444', '2021-08-30', 'Recepção', 3500.00, true),
('55555555-5555-5555-5555-555555555555', 'Assistente Marcos Ferreira', 'administrative', '(11) 99999-5555', '555.555.555-55', 'GO-77.777.777', '2022-01-10', 'Administrativo', 3500.00, true),

-- Staff (General employees)
('66666666-6666-6666-6666-666666666666', 'Fisioterapeuta Lucia Pereira', 'staff', '(11) 99999-6666', '666.666.666-66', 'SC-66.666.666', '2022-02-01', 'Fisioterapia', 6000.00, true),
('77777777-7777-7777-7777-777777777777', 'Psicoterapeuta Roberto Alves', 'staff', '(11) 99999-7777', '777.777.777-77', 'RS-55.555.555', '2022-05-15', 'Psicoterapia', 6000.00, true),
...
SELECT 
  ...
  CASE 
    ...
    WHEN p.name LIKE '%Recep%' THEN 'Recepção'
    WHEN p.name LIKE '%Assist%' THEN 'Administrativo'
    ELSE 'Geral'
