-- Atualizar função validate_attendance_report para permitir estoque negativo
-- Remove a verificação de quantidade suficiente no estoque
...
CREATE OR REPLACE FUNCTION public.validate_attendance_report(
  ...
  p_payment_method text DEFAULT 'dinheiro'::text
)
RETURNS boolean
LANGUAGE plpgsql
SECURITY DEFINER
        ...
        IF current_stock_qty IS NOT NULL THEN
          ...
          BEGIN
            ...
            INSERT INTO stock_movements (
              ...
              material_quantity,
              current_stock_qty,
              current_stock_qty - material_quantity,  -- Pode ficar negativo
              material_unit_cost,
              material_total_cost,
