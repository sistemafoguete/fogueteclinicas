-- Corrigir função removendo campo problemático
...
BEGIN
  ...
  -- Insert directly into auth.users com apenas campos permitidos
...
SELECT public.create_employee_direct(
  'funcionario.corrigido@empresa.com',
  'senha123456',
  'Funcionário Corrigido',
  'staff'::employee_role,
  '11977776666',
  'Administração'
);